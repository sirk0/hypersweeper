...
ARCH_PRESETS = {
    "elongated": {
        "flat": {"easy": (6, 2, 8, 65.143), "medium": (12, 3, 30, 36.385), "hard": (17, 5, 94, 25.0)},
        "torus": {"easy": (14, 1, 16, 0.28), "medium": (15, 3, 61, 0.52), "hard": (27, 3, 123, 0.38)},
        "cylinder": {"easy": (12, 1 + 1 / (2 + ROOT3), 8, -0.5), "medium": (13, 3 + 1 / (2 + ROOT3), 39, -0.5), "hard": (17, 4 + 1 / (2 + ROOT3), 89, -0.5)},
        "mobius": {"easy": (12, 1, 9), "medium": (19, 2, 37), "hard": (26, 3, 98)},
        "klein": {"easy": (13, 1, 17, 0.85), "medium": (22, 2, 59, 0.85), "hard": (27, 3, 122, 1.15)},
    },
    "snubsquare": {
        "flat": {"easy": (4, 3, 7, 54), "medium": (6, 6, 35, 38.217), "hard": (9, 9, 108, 26.149)},
        "torus": {"easy": (7, 2, 9, 0.28), "medium": (11, 4, 61, 0.33), "hard": (16, 5, 131, 0.28)},
        "cylinder": {"easy": (12, 1, 7), "medium": (12, 4, 47), "hard": (12, 7, 119)},
    ...
    "trihex": {
        ...
        "cylinder": {"easy": (12, 1, 7, ROOT3 / 2), "medium": (12, 4, 49, ROOT3 / 2), "hard": (12, 7, 113, ROOT3 / 2)},
        "mobius": {"easy": (12, 1, 10), "medium": (12, 4, 55), "hard": (16, 5, 107)},
        "klein": {"easy": (7, 2, 18, 1.15), "medium": (14, 3, 56, 1.15), "hard": (16, 5, 122, 1.3)},
    },
    "snubhex": {
        "flat": {"easy": (2, 2, 8, 56.737), "medium": (5, 3, 39, 33), "hard": (7, 4, 101, 23.771)},
        "torus": {"easy": (5, 1, 18, 0.38), "medium": (7, 2, 51, 0.45), "hard": (8, 3, 110, 0.49)},
        "cylinder": {"easy": (5, 1, 9, 21**0.5 / 4), "medium": (13, 1, 23, 21**0.5 / 4), "hard": (12, 2, 75, 21**0.5 / 4)},
    },
    "truncsquare": {
        "flat": {"easy": (6, 6, 8, 29), "medium": (11, 11, 26, 17.375), "hard": (15, 15, 64, 13.075)},
        "torus": {"easy": (10, 4, 8, 0.33), "medium": (21, 6, 39, 0.28), "hard": (24, 10, 98, 0.38)},
        "cylinder": {"easy": (12, 3, 8), "medium": (12, 11, 36), "hard": (16, 16, 93)},
        "mobius": {"easy": (12, 3, 7), "medium": (13, 10, 34), "hard": (20, 12, 84)},
        "klein": {"easy": (10, 4, 8, 1.15), "medium": (16, 8, 48, 1.3), "hard": (24, 10, 98, 1.3)},
    },
    "trunchex": {
        "flat": {"easy": (4, 3, 7, 26.6), "medium": (8, 5, 25, 14), "hard": (12, 7, 52, 9.308)},
        "torus": {"easy": (7, 2, 8, 0.45), "medium": (14, 3, 25, 0.35), "hard": (20, 4, 48, 0.33)},
        "cylinder": {"easy": (12, 1, 7, 0.5 + ROOT3 / 2), "medium": (12, 4, 28, 0.5 + ROOT3 / 2), "hard": (12, 7, 50, 0.5 + ROOT3 / 2)},
        "mobius": {"easy": (12, 1, 7), "medium": (12, 4, 28), "hard": (16, 5, 48)},
        "klein": {"easy": (7, 2, 8, 1.0), "medium": (14, 3, 25, 1.15), "hard": (16, 5, 48, 1.3)},
    },
    "rhombitrihex": {
        "flat": {"easy": (4, 2, 10, 38.0), "medium": (6, 3, 21, 26.53), "hard": (8, 5, 59, 19.979)},
        "torus": {"easy": (7, 1, 9, 0.28), "medium": (11, 2, 37, 0.28), "hard": (13, 3, 81, 0.38)},
        "cylinder": {"easy": (7, 1, 8), "medium": (12, 2, 28), "hard": (12, 3, 57)},
        "mobius": {"easy": (7, 1, 8), "medium": (12, 2, 28), "hard": (12, 3, 59)},
        "klein": {"easy": (7, 1, 10, 0.7), "medium": (11, 2, 35, 0.85), "hard": (13, 3, 81, 1.15)},
    },
    "trunctrihex": {
        "flat": {"easy": (3, 2, 7, 27.89), "medium": (6, 3, 27, 14.864), "hard": (8, 5, 76, 11.25)},
        "torus": {"easy": (6, 1, 12, 0.33), "medium": (11, 2, 41, 0.28), "hard": (13, 3, 87, 0.38)},
        "cylinder": {"easy": (7, 1, 8), "medium": (12, 2, 33), "hard": (12, 3, 71)},
        "mobius": {"easy": (7, 1, 9), "medium": (12, 2, 38), "hard": (12, 3, 70)},
    ...
    "prismaticpent": {
        "flat": {"easy": (9, 2, 10, 45.6), "medium": (14, 4, 40, 31.533), "hard": (21, 6, 103, 20.455)},
        "torus": {"easy": (20, 1, 11, 0.28), "medium": (21, 3, 58, 0.45), "hard": (40, 3, 118, 0.28)},
        "cylinder": {"easy": (18, 1 + 1 / (2 + ROOT3), 10, -0.5), "medium": (16, 4 + 1 / (2 + ROOT3), 51, -0.5), "hard": (23, 6 + 1 / (2 + ROOT3), 129, -0.5)},
        "mobius": {"easy": (18, 1, 8), "medium": (28, 2, 43), "hard": (33, 4, 120)},
        "klein": {"easy": (19, 1, 10, 0.7), "medium": (21, 3, 56, 1.3), "hard": (40, 3, 116, 0.85)},
    },
    "cairo": {
        "flat": {"easy": (4, 5, 9, 54), "medium": (8, 8, 25, 28.559), "hard": (11, 11, 83, 21.226)},
        "torus": {"easy": (7, 3, 12, 0.38), "medium": (16, 4, 45, 0.28), "hard": (20, 6, 105, 0.28)},
        "cylinder": {"easy": (12, 2, 13), "medium": (12, 6, 47), "hard": (12, 11, 113)},
        "mobius": {"easy": (19, 2, 10), "medium": (23, 5, 41), "hard": (33, 7, 93)},
        "klein": {"easy": (13, 3, 14, 1.3), "medium": (25, 5, 50, 1.15), "hard": (35, 7, 107, 1.15)},
    },
    "rhombille": {
        "flat": {"easy": (4, 3, 7, 48), "medium": (8, 5, 24, 26.667), "hard": (12, 7, 51, 16.923)},
        "torus": {"easy": (7, 2, 8, 0.45), "medium": (14, 3, 25, 0.33), "hard": (20, 4, 48, 0.33)},
        "cylinder": {"easy": (12, 1, 7, ROOT3 / 2), "medium": (12, 4, 28, ROOT3 / 2), "hard": (12, 7, 50, ROOT3 / 2)},
        "mobius": {"easy": (12, 1, 7), "medium": (14, 3, 25), "hard": (17, 5, 51)},
        "klein": {"easy": (7, 2, 8, 1.3), "medium": (11, 4, 26, 1.3), "hard": (16, 5, 48, 1.3)},
    },
    "floret": {
        "flat": {"easy": (3, 2, 7, 44), "medium": (6, 4, 34, 26.591), "hard": (8, 5, 79, 20.414)},
        "torus": {"easy": (7, 1, 12, 0.28), "medium": (11, 2, 47, 0.28), "hard": (13, 3, 97, 0.38)},
        "cylinder": {"easy": (7, 1, 9, 21**0.5 / 4), "medium": (12, 2, 36, 21**0.5 / 4), "hard": (12, 3, 76, 21**0.5 / 4)},
    },
    "tetrakis": {
        "flat": {"easy": (4, 5, 8, 43.5), "medium": (8, 8, 27, 24.938), "hard": (11, 12, 62, 17.609)},
        "torus": {"easy": (7, 3, 8, 0.52), "medium": (16, 4, 28, 0.28), "hard": (16, 7, 68, 0.45)},
        "cylinder": {"easy": (12, 2, 9), "medium": (12, 6, 32), "hard": (12, 11, 74)},
        "mobius": {"easy": (12, 2, 11), "medium": (12, 6, 28), "hard": (15, 8, 69)},
        "klein": {"easy": (7, 3, 9, 1.3), "medium": (21, 3, 25, 0.7), "hard": (24, 5, 65, 0.85)},
    },
    "triakis": {
        ...
        "cylinder": {"easy": (7, 1, 11, 0.5 + ROOT3 / 2), "medium": (12, 2, 46, 0.5 + ROOT3 / 2), "hard": (12, 3, 86, 0.5 + ROOT3 / 2)},
        "mobius": {"easy": (3, 2, 9), "medium": (12, 2, 46), "hard": (13, 3, 94)},
        "klein": {"easy": (3, 2, 9, 1.3), "medium": (11, 2, 42, 1.3), "hard": (20, 2, 96, 0.7)},
    },
    "deltoidal": {
        "flat": {"easy": (3, 2, 8, 49.692), "medium": (6, 4, 34, 26.88), "hard": (8, 5, 86, 20.212)},
        "torus": {"easy": (7, 1, 12, 0.28), "medium": (11, 2, 42, 0.28), "hard": (13, 3, 97, 0.38)},
        "cylinder": {"easy": (7, 1, 12), "medium": (12, 2, 44), "hard": (12, 3, 90)},
        "mobius": {"easy": (7, 1, 12), "medium": (12, 2, 38), "hard": (12, 3, 86)},
        "klein": {"easy": (6, 1, 12, 0.85), "medium": (10, 2, 41, 1.0), "hard": (13, 3, 99, 1.15)},
    },
    "kisrhombille": {
        "flat": {"easy": (3, 1, 7, 28), "medium": (4, 3, 28, 22.5), "hard": (6, 3, 50, 15.167)},
        "torus": {"easy": (3, 1, 8, 0.52), "medium": (6, 2, 28, 0.52), "hard": (10, 2, 65, 0.33)},
        "cylinder": {"easy": (3, 1, 7), "medium": (12, 1, 28), "hard": (17, 1, 40)},
        "mobius": {"easy": (3, 1, 7), "medium": (12, 1, 28), "hard": (17, 1, 40)},
        "klein": {"easy": (3, 1, 7, 1.3), "medium": (6, 2, 30, 1.3), "hard": (10, 2, 68, 1.0)},
    },
    ...
    "offsetsquare": {
        ...
        "cylinder": {"easy": (12, 3.5, 15), "medium": (16, 8, 50), "hard": (22, 11, 114)},
        "mobius": {"easy": (13, 3, 12), "medium": (19, 7, 55), "hard": (26, 9, 109)},
    ...
    "staggeredtri": {
        ...
        "cylinder": {"easy": (12, 1.5, 10), "medium": (12, 6, 64), "hard": (14, 8.5, 120)},
        "mobius": {"easy": (13, 3, 14), "medium": (25, 5, 54), "hard": (35, 7, 124)},
        "klein": {"easy": (21, 2, 18, 1.0), "medium": (27, 5, 66, 1.15), "hard": (31, 8, 134, 1.0)},
    },
    "pythagorean": {
        "flat": {"easy": (2, 4, 9, 81.333), "medium": (5, 5, 32, 38.077), "hard": (7, 7, 77, 27.556)},
        "torus": {"easy": (4, 2, 12, 0.38), "medium": (9, 3, 47, 0.33), "hard": (12, 4, 96, 0.33)},
        "cylinder": {"easy": (5, 1.5, 10), "medium": (15, 1.5, 25), "hard": (12, 4, 84)},
    },
    "rotatedhex": {
        "flat": {"easy": (4, 3, 7, 48.212), "medium": (8, 5, 25, 28.814), "hard": (12, 7, 52, 20.329)},
        "torus": {"easy": (7, 2, 8, 0.45), "medium": (14, 3, 25, 0.33), "hard": (20, 4, 48, 0.33)},
        "cylinder": {"easy": (12, 1.5, 10), "medium": (12, 4, 28), "hard": (12, 6.5, 46)},
    },
    "rotatedtri": {
        ...
        "cylinder": {"easy": (12, 1.5, 11), "medium": (12, 3.5, 46), "hard": (12, 6.5, 105)},
    },
    "threescaletri": {
        "flat": {"easy": (5, 3, 9, 65), "medium": (8, 5, 36, 40.929), "hard": (12, 7, 104, 27.104)},
        "torus": {"easy": (7, 2, 18, 0.45), "medium": (14, 3, 56, 0.33), "hard": (20, 4, 120, 0.33)},
        "cylinder": {"easy": (12, 1.5, 17), "medium": (12, 4, 55), "hard": (12, 6.5, 112)},
    },
    ...
    "stackedbond": {
        "flat": {"easy": (6, 12, 9, 70), "medium": (10, 22, 36, 45), "hard": (15, 31, 99, 32.933)},
        "torus": {"easy": (14, 6, 8, 0.38), "medium": (23, 11, 58, 0.45), "hard": (32, 15, 129, 0.45)},
        "cylinder": {"easy": (12, 7.5, 13), "medium": (12, 23.5, 52), "hard": (15, 31, 110)},
        "mobius": {"easy": (13, 7, 13), "medium": (18, 15, 51), "hard": (23, 20, 112)},
    ...
    "runningbond": {
        ...
        "cylinder": {"easy": (12, 3, 12), "medium": (12, 11.5, 57), "hard": (16, 16, 120)},
        "mobius": {"easy": (12, 3, 12), "medium": (17, 7, 50), "hard": (23, 10, 109)},
    ...
    "basketweave": {
        ...
        "cylinder": {"easy": (4, 2.5, 14), "medium": (12, 2.5, 39), "hard": (12, 5.5, 107)},
        "mobius": {"easy": (13, 2, 15), "medium": (19, 3, 39), "hard": (23, 5, 92)},
        "klein": {"easy": (11, 2, 12, 1.3), "medium": (17, 4, 50, 1.15), "hard": (23, 5, 104, 1.3)},
    },
    "basketweave3": {
        "flat": {"easy": (2, 3, 7, 105), "medium": (4, 5, 24, 54), "hard": (6, 6, 64, 37.5)},
        "torus": {"easy": (3, 2, 15, 0.45), "medium": (7, 3, 53, 0.38), "hard": (10, 4, 115, 0.38)},
        "cylinder": {"easy": (7, 1, 8), "medium": (13, 1.5, 23), "hard": (12, 3, 68)},
        "mobius": {"easy": (13, 1, 7), "medium": (15, 3, 27), "hard": (19, 4, 77)},
    ...
    "herringbone": {
        ...
        "cylinder": {"easy": (4, 2.5, 12), "medium": (12, 2.5, 41), "hard": (12, 5.5, 117)},
    },
}
