...
ARCH_PRESETS = {
    "elongated": {
        ...
        "cylinder": {"easy": (12, 1 + 1 / (2 + ROOT3), 6, -0.5), "medium": (13, 3 + 1 / (2 + ROOT3), 37, -0.5), "hard": (17, 4 + 1 / (2 + ROOT3), 93, -0.5)},
        "mobius": {"easy": (12, 1, 11), "medium": (19, 2, 37), "hard": (26, 3, 100)},
    ...
    "snubsquare": {
        ...
        "cylinder": {"easy": (7, 2, 12), "medium": (7, 7, 52), "hard": (9, 9, 117)},
    ...
    "trihex": {
        ...
        "torus": {"easy": (7, 2, 18, 0.45), "medium": (15, 3, 60, 0.33), "hard": (20, 4, 118, 0.33)},
        "cylinder": {"easy": (6, 2, 12, ROOT3 / 2), "medium": (9, 5, 52, ROOT3 / 2), "hard": (12, 7, 112, ROOT3 / 2)},
        "mobius": {"easy": (7, 2, 13), "medium": (11, 4, 51), "hard": (16, 5, 107)},
        "klein": {"easy": (7, 2, 18, 1.15), "medium": (14, 3, 54, 1.15), "hard": (16, 5, 122, 1.3)},
    },
    "snubhex": {
        "flat": {"easy": (2, 2, 8, 56.737), "medium": (5, 3, 32, 33), "hard": (7, 4, 104, 23.771)},
        "torus": {"easy": (5, 1, 18, 0.38), "medium": (7, 2, 51, 0.45), "hard": (8, 3, 107, 0.49)},
        "cylinder": {"easy": (5, 1, 6, 21**0.5 / 4), "medium": (5, 3, 34, 21**0.5 / 4), "hard": (7, 4, 100, 21**0.5 / 4)},
    },
    "truncsquare": {
        ...
        "cylinder": {"easy": (10, 4, 8), "medium": (11, 11, 37), "hard": (16, 16, 88)},
        "mobius": {"easy": (10, 4, 8), "medium": (13, 10, 34), "hard": (20, 12, 81)},
    ...
    "trunchex": {
        ...
        "cylinder": {"easy": (5, 3, 5, 0.5 + ROOT3 / 2), "medium": (9, 5, 17, 0.5 + ROOT3 / 2), "hard": (12, 7, 39, 0.5 + ROOT3 / 2)},
        "mobius": {"easy": (7, 2, 4), "medium": (11, 4, 13), "hard": (16, 5, 34)},
    ...
    "rhombitrihex": {
        ...
        "cylinder": {"easy": (6, 1, 5), "medium": (6, 4, 28), "hard": (8, 5, 67)},
        "mobius": {"easy": (6, 1, 5), "medium": (7, 3, 28), "hard": (10, 4, 64)},
    ...
    "trunctrihex": {
        ...
        "cylinder": {"easy": (6, 1, 7), "medium": (6, 4, 39), "hard": (8, 5, 82)},
        "mobius": {"easy": (6, 1, 8), "medium": (8, 3, 35), "hard": (10, 4, 82)},
    ...
    "prismaticpent": {
        ...
        "cylinder": {"easy": (18, 1 + 1 / (2 + ROOT3), 8, -0.5), "medium": (16, 4 + 1 / (2 + ROOT3), 51, -0.5), "hard": (22, 6 + 1 / (2 + ROOT3), 123, -0.5)},
        "mobius": {"easy": (18, 1, 8), "medium": (28, 2, 43), "hard": (33, 4, 118)},
    ...
    "cairo": {
        ...
        "cylinder": {"easy": (9, 2, 12), "medium": (8, 8, 43), "hard": (11, 11, 104)},
        "mobius": {"easy": (15, 3, 14), "medium": (23, 5, 41), "hard": (33, 7, 93)},
    ...
    "rhombille": {
        ...
        "cylinder": {"easy": (6, 2, 6, ROOT3 / 2), "medium": (9, 5, 9, ROOT3 / 2), "hard": (12, 7, 20, ROOT3 / 2)},
        "mobius": {"easy": (12, 1, 6), "medium": (14, 3, 9), "hard": (17, 5, 20)},
    ...
    "floret": {
        ...
        "cylinder": {"easy": (7, 1, 9, 21**0.5 / 4), "medium": (7, 3, 34, 21**0.5 / 4), "hard": (8, 5, 90, 21**0.5 / 4)},
    },
    "tetrakis": {
        "flat": {"easy": (3, 6, 5, 43.5), "medium": (8, 8, 27, 24.938), "hard": (10, 12, 68, 21.131)},
        "torus": {"easy": (7, 3, 7, 0.52), "medium": (16, 4, 29, 0.28), "hard": (16, 7, 68, 0.45)},
        "cylinder": {"easy": (9, 2, 8), "medium": (9, 8, 29), "hard": (11, 11, 69)},
        "mobius": {"easy": (10, 2, 8), "medium": (11, 6, 27), "hard": (15, 8, 69)},
    ...
    "triakis": {
        ...
        "cylinder": {"easy": (7, 1, 11, 0.5 + ROOT3 / 2), "medium": (7, 3, 40, 0.5 + ROOT3 / 2), "hard": (8, 5, 96, 0.5 + ROOT3 / 2)},
        "mobius": {"easy": (7, 1, 11), "medium": (7, 3, 40), "hard": (8, 5, 96)},
    ...
    "deltoidal": {
        ...
        "cylinder": {"easy": (6, 1, 10), "medium": (6, 4, 44), "hard": (8, 5, 100)},
        "mobius": {"easy": (6, 1, 10), "medium": (10, 2, 37), "hard": (12, 3, 89)},
    ...
    "kisrhombille": {
        ...
        "cylinder": {"easy": (6, 1, 6), "medium": (6, 2, 22), "hard": (6, 3, 56)},
        "mobius": {"easy": (6, 1, 7), "medium": (6, 2, 18), "hard": (9, 2, 48)},
    ...
    "offsetsquare": {
        ...
        "cylinder": {"easy": (12, 3.5, 15), "medium": (16, 8, 55), "hard": (22, 11, 114)},
        "mobius": {"easy": (13, 3, 12), "medium": (19, 7, 53), "hard": (26, 9, 111)},
    ...
    "staggeredtri": {
        ...
        "cylinder": {"easy": (12, 1.5, 14), "medium": (12, 6, 62), "hard": (14, 8.5, 120)},
        "mobius": {"easy": (13, 3, 14), "medium": (25, 5, 54), "hard": (35, 7, 122)},
    ...
    "pythagorean": {
        ...
        "cylinder": {"easy": (5, 1.5, 10), "medium": (5, 5.5, 43), "hard": (7, 7, 89)},
    },
    "rotatedhex": {
        ...
        "cylinder": {"easy": (5, 2.5, 4), "medium": (9, 5, 13), "hard": (12, 6.5, 32)},
    },
    "rotatedtri": {
        ...
        "cylinder": {"easy": (9, 1.5, 11), "medium": (9, 5.5, 59), "hard": (12, 6.5, 105)},
    },
    "threescaletri": {
        ...
        "cylinder": {"easy": (9, 1.5, 12), "medium": (9, 5, 54), "hard": (12, 6.5, 111)},
    },
    ...
    "stackedbond": {
        ...
        "cylinder": {"easy": (12, 7.5, 13), "medium": (12, 23.5, 52), "hard": (15, 31, 113)},
        "mobius": {"easy": (12, 7, 15), "medium": (17, 15, 48), "hard": (23, 20, 112)},
    ...
    "runningbond": {
        ...
        "cylinder": {"easy": (12, 3, 14), "medium": (12, 11.5, 57), "hard": (16, 16, 120)},
        "mobius": {"easy": (12, 3, 12), "medium": (17, 7, 50), "hard": (23, 10, 108)},
    ...
    "basketweave": {
        ...
        "cylinder": {"easy": (6, 1.5, 10), "medium": (6, 5.5, 47), "hard": (8, 7.5, 102)},
    ...
    "basketweave3": {
        ...
        "cylinder": {"easy": (6, 1, 5), "medium": (5, 4.5, 27), "hard": (6, 6, 82)},
    ...
    "herringbone": {
        ...
        "cylinder": {"easy": (6, 1.5, 10), "medium": (6, 5.5, 50), "hard": (8, 7.5, 111)},
    },
}
