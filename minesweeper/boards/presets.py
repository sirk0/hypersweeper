...
ARCH_PRESETS = {
    "elongated": {
        ...
        "cylinder": {"easy": (13, 1 + 1 / (2 + ROOT3), 6, -0.5), "medium": (22, 2 + 1 / (2 + ROOT3), 45, -0.5), "hard": (32, 2 + 1 / (2 + ROOT3), 79, -0.5)},
        "mobius": {"easy": (12, 1, 11), "medium": (23, 2, 40), "hard": (30, 3, 112)},
    ...
    "trihex": {
        ...
        "cylinder": {"easy": (9, 1.5, 9, ROOT3 / 2), "medium": (15, 3, 47, ROOT3 / 2), "hard": (21, 4, 102, ROOT3 / 2)},
        "mobius": {"easy": (7, 2, 13), "medium": (16, 3, 52), "hard": (21, 4, 111)},
    ...
    "snubhex": {
        ...
        "cylinder": {"easy": (5, 1, 6, 21**0.5 / 4), "medium": (9, 1.5, 24, 21**0.5 / 4), "hard": (12, 2, 71, 21**0.5 / 4)},
    },
    "truncsquare": {
        ...
        "cylinder": {"easy": (11, 3.5, 8), "medium": (20, 6.5, 40), "hard": (28, 8.5, 85)},
        "mobius": {"easy": (11, 4, 9), "medium": (20, 6, 32), "hard": (28, 9, 84)},
    ...
    "trunchex": {
        ...
        "cylinder": {"easy": (9, 1.5, 4, 0.5 + ROOT3 / 2), "medium": (15, 3, 13, 0.5 + ROOT3 / 2), "hard": (21, 4, 34, 0.5 + ROOT3 / 2)},
        "mobius": {"easy": (7, 2, 4), "medium": (16, 3, 10), "hard": (21, 4, 34)},
    ...
    "rhombitrihex": {
        ...
        "cylinder": {"easy": (6, 1, 5), "medium": (11, 2, 21), "hard": (15, 2.5, 59)},
        "mobius": {"easy": (6, 1, 5), "medium": (11, 2, 22), "hard": (15, 3, 68)},
    ...
    "trunctrihex": {
        ...
        "cylinder": {"easy": (6, 1, 7), "medium": (11, 2, 32), "hard": (15, 2.5, 58)},
        "mobius": {"easy": (6, 1, 8), "medium": (11, 2, 31), "hard": (15, 3, 83)},
    ...
    "prismaticpent": {
        ...
        "cylinder": {"easy": (18, 1 + 1 / (2 + ROOT3), 8, -0.5), "medium": (28, 2 + 1 / (2 + ROOT3), 42, -0.5), "hard": (39, 3 + 1 / (2 + ROOT3), 102, -0.5)},
    ...
    "cairo": {
        ...
        "cylinder": {"easy": (8, 2.5, 12), "medium": (14, 4.5, 41), "hard": (20, 6, 95)},
    ...
    "rhombille": {
        ...
        "cylinder": {"easy": (9, 1.5, 6, ROOT3 / 2), "medium": (15, 3, 10, ROOT3 / 2), "hard": (21, 4, 20, ROOT3 / 2)},
        "mobius": {"easy": (12, 1, 6), "medium": (16, 3, 10), "hard": (21, 4, 20)},
    ...
    "floret": {
        ...
        "cylinder": {"easy": (7, 1, 9, 21**0.5 / 4), "medium": (11, 2, 33, 21**0.5 / 4), "hard": (15, 2.5, 77, 21**0.5 / 4)},
    },
    "tetrakis": {
        ...
        "cylinder": {"easy": (9, 2.5, 6), "medium": (15, 4.5, 18), "hard": (20, 6, 68)},
    ...
    "triakis": {
        ...
        "cylinder": {"easy": (7, 1, 11, 0.5 + ROOT3 / 2), "medium": (11, 2, 42, 0.5 + ROOT3 / 2), "hard": (15, 2.5, 90, 0.5 + ROOT3 / 2)},
    ...
    "kisrhombille": {
        ...
        "cylinder": {"easy": (6, 1, 6), "medium": (8, 1.5, 17), "hard": (10, 2, 52)},
    ...
    "offsetsquare": {
        ...
        "cylinder": {"easy": (16, 2.5, 11), "medium": (28, 4.5, 48), "hard": (39, 6, 104)},
        "mobius": {"easy": (15, 3, 14), "medium": (28, 5, 53), "hard": (38, 6, 104)},
    ...
    "staggeredtri": {
        ...
        "cylinder": {"easy": (12, 1.5, 14), "medium": (19, 3.5, 56), "hard": (25, 4.5, 109)},
    ...
    "pythagorean": {
        ...
        "cylinder": {"easy": (5, 1.5, 10), "medium": (9, 2.5, 31), "hard": (12, 4, 84)},
    },
    "rotatedhex": {
        ...
        "cylinder": {"easy": (9, 1.5, 4), "medium": (15, 3, 12), "hard": (20, 3.5, 28)},
    },
    "rotatedtri": {
        ...
        "cylinder": {"easy": (9, 1.5, 11), "medium": (16, 2.5, 40), "hard": (21, 3.5, 91)},
    },
    "threescaletri": {
        ...
        "cylinder": {"easy": (9, 1.5, 12), "medium": (15, 3, 51), "hard": (20, 3.5, 94)},
    },
    ...
    "stackedbond": {
        ...
        "cylinder": {"easy": (12, 7.5, 13), "medium": (21, 13.5, 48), "hard": (28, 17.5, 112)},
    ...
    "runningbond": {
        ...
        "cylinder": {"easy": (12, 3.5, 17), "medium": (20, 6.5, 52), "hard": (28, 8.5, 111)},
        "mobius": {"easy": (12, 3, 12), "medium": (20, 6, 46), "hard": (28, 9, 117)},
    ...
    "basketweave": {
        ...
        "cylinder": {"easy": (6, 1.5, 10), "medium": (10, 3.5, 46), "hard": (14, 4.5, 101)},
    ...
    "herringbone": {
        ...
        "cylinder": {"easy": (6, 1.5, 10), "medium": (10, 3.5, 52), "hard": (14, 4.5, 110)},
    },
}
