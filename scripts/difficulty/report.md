...
- 32 could not be brought on target:
  - `cube3d`/hard: 45.5% vs 50.9% — the search could not resolve it -- its thinnest measurement finished 2 game(s), so the rate here is noise rather than a crossing the search walked to. Re-measure at a bigger `--budget`
...
| `brickrings` | 5.3 | 72c 12m (17%) 97% | 242c 47m (19%) 90% | 512c 114m (22%) 53% |
...
| `cube3d` | 14.6 | 64c 11m (17%) 98% | 216c 43m (20%) 90% | 512c 115m (22%) 45% ⚠ |
